    ...
    def add_ground(self, ground_plane=None, length=25.0, color0=[0.8, 0.9, 0.9], color1=[0.6, 0.7, 0.7], tile_width=0.5, xyz_orig=None, alpha=1.0):
        ...
        for i in range(num_rows):
            for j in range(num_cols):
                ...
                cur_verts = np.array([[start_loc[0], 0.0, start_loc[1]],
                        [start_loc[0], 0.0, start_loc[1]-tile_width],
                        [start_loc[0]+tile_width, 0.0, start_loc[1]-tile_width],
                        [start_loc[0]+tile_width, 0.0, start_loc[1]]])
