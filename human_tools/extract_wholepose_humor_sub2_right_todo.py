...
def main(take_folder, device):
    ...
    meshes_dir = osp.join(take_folder, "processed/rgbd0/humor_out_v3/body_meshes_humor_sub2")
    ...
    body_file = results_out+"/"+ folders[0] + '/stage2_results.npz'
    ...
    if save_meshes:
        ...
        for ii in range(n):
            ...
            filename =  "humor_body_%s.ply" % (fram_name)                                                            
