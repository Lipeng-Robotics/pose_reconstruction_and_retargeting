...
class BaseConfig():
    ...
    def __init__(self, argv):
        ...
        self.parser.add_argument('--dataset', type=str, required=True, choices=['H2tcDataset'], help='The name of the dataset type.')
...
class H2tcDatasetConfig(BaseSubConfig):
    '''
    Configuration for arguments specific to models.H2tcDataset dataset class.
    '''
    def __init__(self, argv):
        super(H2tcDatasetConfig, self).__init__(argv)
