...
from util_tool.transforms import convert_to_rotmat, compute_world2aligned_mat, rotation_matrix_to_angle_axis
from human_tools.body_model import BodyModel, SMPL_JOINTS,SMPLH_PATH
from h2tc_dataset import data_name_list, data_dim
    ...
    def decode(self, z, past_in):
        ...
        if self.output_delta:
            ...
            for in_dim_idx, out_dim_idx, data_name in zip(self.input_dim_list, decode_out_dim_list, self.data_names):
                ...
                if data_name in ['root_orient', 'pose_body']: # lx: decode the delta state, add residual to input
