...
def parse_args(argv):
    ...
    parser.add_argument('--data-type', type=str, choices=['RGB'], default='RGB', help='The type of data we are fitting to.')
    ...
    # smpl model path
    parser.add_argument('--smplh', type=str, default='./body_models/smplh/neutral/model.npz', help='Path to SMPL model to use for optimization. Currently only SMPL+H is supported.')
    ...
    parser.add_argument('--is-sub1', type=str, default='sub1', choices=['sub1', 'sub2'], help="Extract the whole poses of sub1 left person?")
    parser.add_argument('--vis', dest='vis', action='store_true')
    parser.set_defaults(vis=False)
    parser.add_argument('--cal-cam', dest='cal_cam', action='store_true')
    parser.set_defaults(cal_cam=False)
    parser.add_argument('--catch-throw', type=str, default='throw', choices=['catch', 'throw'])
